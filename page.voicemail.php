...
$gen_settings = array(		"adsifdn" 			=> array("ver" => 1.2, "len" => 4, "type" => "char", "default" => ""),
				...
				"imapimpersonationmethod"       => array("ver" => 1.4, "len" => $dlen, "type" => "char", "default" => ""),
				"imapauthtype"                  => array("ver" => 1.4, "len" => $dlen, "type" => "char", "default" => "None"),
				"imaptestuser"                  => array("ver" => 1.4, "len" => $dlen, "type" => "char", "default" => ""),
