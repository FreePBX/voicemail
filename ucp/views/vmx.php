...
<form role="form">
	...
	<div class="form-group">
		...
		<span class="radioset">
			<input type="checkbox" class="vmx-setting" name="vmx-usewhen-unavailable" id="vmx-usewhen-unavailable" value="true" <?php echo (isset($settings['unavail']) && $settings['unavail']['state'] == 'enabled') ? 'checked' : ''?>>
			<label for="vmx-usewhen-unavailable"><?php echo _('Unavailable')?></label>
			<input type="checkbox" class="vmx-setting" name="vmx-usewhen-busy" id="vmx-usewhen-busy" value="true" <?php echo (isset($settings['bust']) && $settings['bust']['state'] == 'enabled') ? 'checked' : ''?>>
	...
	<div class="form-group">
		...
		<div class="input-group">
			<span class="input-group-addon">
				<input type="checkbox" class="vmx-setting" id="vmx-p0_enable" name="vmx-p0_enable" data-el="vmx-p0" value="true" <?php echo (isset($settings['unavail']) && !empty($settings['unavail'][0]['ext'])) ? 'checked' : ''?>>
			</span>
			<input type="text" class="form-control vmx-setting" id="vmx-p0" name="vmx-opt0" data-type="vmx-p0" placeholder="<?php echo _('Go To Operator')?>" data-ph="<?php echo _('Go To Operator')?>" value="<?php echo (isset($settings['unavail']) && !empty($settings['unavail'][0]['ext'])) ? $settings['unavail'][0]['ext'] : ''?>">
		</div>
	...
	<div class="form-group">
		...
		<div class="input-group">
			<span class="input-group-addon">
				<input type="checkbox" class="vmx-setting" id="vmx-p1_enable" name="vmx-p1_enable" data-el="vmx-p1" value="true" <?php echo (isset($settings['unavail']) && (!empty($settings['unavail'][1]['ext'])) && $settings['unavail'][1]['ext'] != $fmfm) ? 'checked' : ''?>>
			</span>
			<input type="text" class="form-control vmx-setting" id="vmx-p1" name="vmx-opt1" data-type="vmx-p1" placeholder="<?php echo _('Send to Follow-Me')?>" data-ph="<?php echo _('Send to Follow-Me')?>" value="<?php echo (isset($settings['unavail']) && (!empty($settings['unavail'][1]['ext']) && $settings['unavail'][1]['ext'] != $fmfm)) ? $settings['unavail'][1]['ext'] : ''?>">
		</div>
	...
	<div class="form-group">
		...
		<input name="vmx-opt2" type="text" class="form-control vmx-setting" id="vmx-p2" value="<?php echo (isset($settings['unavail']) && !empty($settings['unavail'][2]['ext'])) ? $settings['unavail'][2]['ext'] : ''?>" autocapitalize="off" autocorrect="off">
