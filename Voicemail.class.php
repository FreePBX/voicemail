...
class Voicemail extends FreePBX_Helpers implements BMO {
	...
	*/
	...
	public function constructSettings($level="general") {
		$ipAddress = exec("".fpbx_which('ifconfig')." | grep -Eo 'inet (addr:)?([0-9]*\.){3}[0-9]*' | grep -Eo '([0-9]*\.){3}[0-9]*' | grep -v '127.0.0.1'");
		// UCP - User Control Panel. Default port 81
		$ucpLink = 'http://'.$ipAddress.':81/ucp';
		$settings = array(
			"general" => array(
				"name" => _("General"),
				"helptext" => "",
			...
			"email" => array(
				...
				"settings" => array(
					...
					"emailbody" => array(
						"level" => array("general"),
						"type" => "textbox",
						"default" => '${VM_NAME},\n\nThere is a new voicemail in mailbox ${VM_MAILBOX}:\n\n\tFrom:\t${VM_CALLERID}\n\tLength:\t${VM_DUR} seconds\n\tDate:\t${VM_DATE}\n\nDial *98 to access your voicemail by phone.\nVisit '.$ucpLink.' to check your voicemail with a web browser.\n',
						"len" => 512,
